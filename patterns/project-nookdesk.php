<?php
/**
 * Title: Project: Nookdesk
 * Slug: creative-agency/project-nookdesk
...
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/work-nookdesk.webp' ) ); ?>" alt="A white desk with a laptop and a tablet set up in the bright corner of an office" style="aspect-ratio:16/9;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<p class="has-contrast-color has-text-color">Nookdesk</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"textColor":"contrast"} -->
<p class="has-contrast-color has-text-color">Research and iOS app</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"textColor":"contrast"} -->
<p class="has-contrast-color has-text-color">2025</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph -->
<p>Nookdesk runs flexible workspaces in four Bay Area buildings. Members booked desks through a web form and a shared spreadsheet, and on a busy Monday half of them arrived to find their desk already taken.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>We interviewed members and the front-desk team, mapped a week of bookings, and designed an iOS app around the one question people ask on the way in: where can I sit today? Booking takes two taps, and the floor plan shows who is already in.</p>
<!-- /wp:paragraph -->
...
<li>Twenty-two member interviews and a week at the front desk.</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>A live floor plan that replaced the spreadsheet on day one.</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>No-shows down by a third in the first quarter.</li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->
...
<h3 class="wp-block-heading has-text-align-left creative-agency-project-nav__title"><a href="<?php echo esc_url( home_url( '/work/arcade-club/' ) ); ?>">Arcade Club app</a></h3>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<h3 class="wp-block-heading has-text-align-right creative-agency-project-nav__title"><a href="<?php echo esc_url( home_url( '/work/whisk/' ) ); ?>">Whisk design system</a></h3>
<!-- /wp:heading --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
