<?php
/**
 * Title: Works: four projects
 * Slug: creative-agency/works
...
?>
<!-- wp:group {"align":"full","className":"creative-agency-works","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"blockGap":"var:preset|spacing|70"}},"layout":{"type":"constrained"},"anchor":"work"} -->
<div class="wp-block-group alignfull creative-agency-works" id="work" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><!-- wp:paragraph {"className":"is-style-creative-agency-watermark"} -->
