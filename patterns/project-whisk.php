...
/**
 * Title: Project: Whisk
 * Slug: creative-agency/project-whisk
...
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/work-whisk.webp' ) ); ?>" alt="A hand holding up a rainbow-coloured whisk dipped in meringue" style="aspect-ratio:16/9;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<p class="has-contrast-color has-text-color">Whisk</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"textColor":"contrast"} -->
<p class="has-contrast-color has-text-color">Design system</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph -->
<p>Whisk is a recipe app with a small team and a large library: six hundred recipes, three platforms, and a component for every one-off screen anyone had ever needed.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>We audited every screen, cut the component library from 214 parts to 48, and wrote the tokens and documentation that let designers and developers speak the same language. New screens now ship in days rather than sprints.</p>
<!-- /wp:paragraph -->
...
<li>One token set for colour, type and spacing across iOS, Android and web.</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>Forty-eight documented components, each with usage notes and code.</li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li>A contribution process the in-house team now runs without us.</li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->
...
<h3 class="wp-block-heading has-text-align-left creative-agency-project-nav__title"><a href="<?php echo esc_url( home_url( '/work/nookdesk/' ) ); ?>">Nookdesk booking app</a></h3>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<h3 class="wp-block-heading has-text-align-right creative-agency-project-nav__title"><a href="<?php echo esc_url( home_url( '/work/harrow-and-pine/' ) ); ?>">Harrow &amp; Pine packaging</a></h3>
<!-- /wp:heading --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
