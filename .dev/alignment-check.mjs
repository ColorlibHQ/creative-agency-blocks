 ...
 *
 *   WP_URL=https://colorlibhub.com/creative-agency node .dev/alignment-check.mjs
 *   CREATIVE_AGENCY_PATHS=/,/contact/ WP_URL=… node .dev/alignment-check.mjs
 */

import { chromium } from 'playwright';

const base = ( process.env.WP_URL || 'http://127.0.0.1:9492' ).replace( /\/$/, '' );
const paths = ( process.env.CREATIVE_AGENCY_PATHS || '/,/about/,/work/,/work/nookdesk/,/services/,/contact/,/blog/' ).split( ',' );
